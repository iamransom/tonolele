...
<body>
  ...
  <div id="footer" class="noprint">
        ...
        <span class="boton noprint" onclick="irPagina('lista_canciones.php')">VOLVER A LISTA</span>
         <?php
		if(check_login_status()){
		?>
		     <span class="botonchico noprint" onclick="mostrarDiv('editInfo');mostrarDiv('edit')">MODIFICAR INFO</span> <?php 
...
<br>
    ...
    <div id="header">
        ...
        <span id="bot1" class="botontono noprint resaltado" onclick='setTono(0,"bot1");'>IV</span> <span id="bot2" class="botontono noprint" onclick='setTono(1,"bot2");'>DO</span> <span id="bot3" class="botontono noprint" onclick='setTono(3,"bot3");'>RE</span> <span id="bot4" class="botontono noprint" onclick='setTono(5,"bot4");'>MI</span> <span id="bot5" class="botontono noprint" onclick='setTono(6,"bot5");'>FA</span> <span id="bot6" class="botontono noprint" onclick='setTono(8,"bot6");'>SOL</span> <span id="bot6" class="botontono noprint" onclick='setTono(9,"bot6");'>SOL#</span> <span id="bot7" class="botontono noprint" onclick='setTono(10,"bot7");'>LA</span> <span id="bot8" class="botontono noprint" onclick='setTono(11,"bot8");'>SIb</span> <span id="bot8" class="botontono noprint" onclick='setTono(12,"bot8");'>SI</span></h1>
    </div>

    <div id="mainframe">
        <div id="edit">
            <div id="editInfo" class="noprint">
                <form action="editar_cancion_bin.php" class="noprint" method="post">
                    <input class="formulario" type="text" name="idcancion" autocomplete="off" readonly hidden="" value="<?php echo $cancion['id'] ?>"></br>
                    Nombre</br><input class="formulario" type="text" name="nombre" autocomplete="off" value="<?php echo $cancion['nombre'] ?>"></br>
                    De</br><input class="formulario" type="text" name="autor" autocomplete="off" value="<?php echo  $cancion['autor']  ?>"></br>
                    Versión</br><input class="formulario" type="text" name="version" autocomplete="off" value="<?php echo  $cancion['version'] ?>"></br>
                    Tempo</br><input class="formulario" id="tempo" type="number" name="tempo" autocomplete="off" value="<?php echo  $cancion['tempo'] ?>"> <span class="botontono" onclick="taptempo()">TAP</span><br>
                    Cifra Indicadora</br><input class="formulario" type="number" name="cifraindicadora" autocomplete="off" value="<?php echo   $cancion['cifraindicadora'] ?>"><br>
                    Tono Original</br><input class="formulario" type="text" name="tonoorig" autocomplete="off" value="<?php echo $cancion['tonoorig'] ?>"><br>
                    Link Youtube</br><input class="formulario" type="url" name="link1" autocomplete="off" value="<?php echo  $cancion['link1'] ?>"><br>
                    Link2</br><input class="formulario" type="url" name="link2" autocomplete="off" value="<?php echo $cancion['link2']  ?>"><br>
	                Tags</br><input class="formulario" type="text" name="tags" autocomplete="off" value="<?php echo $cancion['tags']  ?>"><br>
                    <center>
...
<?php 
	...
	$id = $matches[1];
	echo '<object class="video noprint" width="' . $width . '" height="' . $height . '"><param class="noprint" name="movie" value="http://www.youtube.com/v/' . $id . '&amp;hl=en_US&amp;fs=1?rel=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/' . $id . '&amp;hl=en_US&amp;fs=1?rel=0" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="' . $width . '" height="' . $height . '"></embed></object>';
	}
	?>
