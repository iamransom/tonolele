...
-->
    ...
    <head>
      ...
      <title>Tonolele - Playlist 9a12</title>
...
/*         $canciones = $m->query('SELECT id, nombre, autor, tags FROM `cdb_canciones`  WHERE `id` == "103" OORDER BY `nombre` ASC'); */
        $canciones = $m->query('SELECT id, nombre, autor, tags FROM `cdb_canciones` WHERE `id` IN (34,65,112,37,40,83,58,35,85,84,86,96,89,91,63,50,51,27,60,69) ORDER BY `nombre` ASC');
        //var_dump($canciones);
  ...
  <div class="demo-layout mdl-layout mdl-layout--fixed-header mdl-js-layout mdl-color--grey-100 ">
    <header class="demo-header mdl-layout__header">
      ...
      <img src="../img/flecha-blanca.png" alt="LAGRAM" height="42" width="42">
        <span class="mdl-layout-title">Tonolele beta</span>
...
<!-- <div class="demo-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--2-col  mdl-cell--8-col-tablet mdl-cell--8-col-phone">
        ...
        <div class="mdl-card demo-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col mdl-cell--hide-phone">
            ...
            <h4 class="mdl-cell mdl-cell--12-col">Playlist 9a12
            ...
            <ul class="mdl-menu mdl-js-menu mdl-menu--bottom-right" for="btn2">
                ...
                <li class="mdl-menu__item"  onclick="imprimirmultiple()">Descargar funciones a PDF</li>
